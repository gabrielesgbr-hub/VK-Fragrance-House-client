                    ...
                    <div className="row mt-4">
                        <div className="col-md-8">
                            <div className="row center">
                                <div className="col-6"><h5>Producto</h5></div>
                                <div className="col-1"><h5>Precio</h5></div>
                                <div className="col-4"><h5>Cantidad</h5></div>
                                <div className="col-1"><h5>Total</h5></div>
                                <hr className='mt-2' />
                            </div>
                            <PerfumeMiPedidoLista perfumes={perfumesPedido}/>
                        </div>
                        <div className="col-md-4 px-5 my-5 center">
